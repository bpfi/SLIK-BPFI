...
public class Shared
{
    ...
    public static void ShowErrorMessage(Page p, string ex)
    {
        ScriptManager.RegisterStartupScript(p, p.GetType(), "fx", "fnShowErrorNotif('" + Shared.DefaultErrorMessage + "', '" + ex + "');", true);
    }
