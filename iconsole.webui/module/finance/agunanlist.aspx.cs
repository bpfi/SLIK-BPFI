...
public partial class module_debitur_agunanlist : BasePageList
{
    private static string TABLE_NAME = "AGUNAN";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "A01";
    private Services cv = new Services();
    private A01Controller dc = new A01Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "AGUNAN";
        NEXT_PAGE = "agunanlist.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityA01> list = new List<EntityA01>();
            list = cv.ConvertDataTable<EntityA01>(_dt);

            bool isCreate = dc.ValidateA01(list, header);

            if (isCreate)
                Shared.ShowSuccessGritter(this, string.Format("agunanlist.aspx"));
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("agunan.aspx?action=edit&cif=" + gvwList.SelectedDataKey[0].ToString()
            + "&kd_registrasi=" + gvwList.SelectedRow.Cells[3].Text
