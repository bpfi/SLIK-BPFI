...
public partial class module_debitur_irrevocablelist : BasePageList
{
    private static string TABLE_NAME = "IRREVOCABLE_LC";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "F04";
    private Services cv = new Services();
    private F04Controller dc = new F04Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "IRREVOCABLE_LC";
        NEXT_PAGE = "irrevocable.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityF04> list = new List<EntityF04>();
            list = cv.ConvertDataTable<EntityF04>(_dt);

            bool isCreate = dc.ValidateF04(list,header);

            if (isCreate)
                Shared.ShowSuccessGritter(this, string.Format("irrevocablelist.aspx"));
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("irrevocable.aspx?action=edit&code=" + gvwList.SelectedDataKey[0].ToString());
    }
}
