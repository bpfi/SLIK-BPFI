<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="pembiayaanjoinaccountlist.aspx.cs" Inherits="module_debitur_pembiayaanjoinaccountlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span>Pembiayaan Join Account List</span>
        </header>
                    ...
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NO_REK_FASILITAS" HeaderText="No. Rek">
                             ...
                             <asp:BoundField DataField="TGL_AKAD_AWAL" HeaderText="Tanggal Akad" DataFormatString="{N:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                            <asp:BoundField DataField="NILAI_PROYEK" HeaderText="Nilai" DataFormatString="{N:0}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                             <asp:BoundField DataField="PLAFON_AWAL" HeaderText="Plafon" DataFormatString="{N:0}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
