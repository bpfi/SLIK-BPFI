...
public partial class module_debitur_bankgaransilist : BasePageList
{
    private static string TABLE_NAME = "BANK_GARANSI";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "F05";
    private Services cv = new Services();
    private F05Controller dc = new F05Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "BANK_GARANSI";
        NEXT_PAGE = "bankgaransilist.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityF05> list = new List<EntityF05>();
            list = cv.ConvertDataTable<EntityF05>(_dt);

            bool isCreate = dc.ValidateF05(list, header);

            if (isCreate)
                Shared.ShowSuccessGritter(this, string.Format("bankgaransilist.aspx"));
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("bankgaransi.aspx?action=edit&code=" + gvwList.SelectedDataKey[0].ToString());
    }
}
