<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="irrevocablelist.aspx.cs" Inherits="module_debitur_irrevocablelist" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TGL_KELUAR" HeaderText="Tanggal Keluar" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="TGL_JATUH_TEMPO" HeaderText="Tanggal Jatuh Tempo" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                             <asp:BoundField DataField="NO_AKAD_AWAL" HeaderText="No. Akad">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                            ...
                            <asp:BoundField DataField="NOMINAL" HeaderText="Nominal" DataFormatString="{0:N}">
                             ...
                             <asp:BoundField DataField="SETORAN_JAMINAN" HeaderText="Jaminan" DataFormatString="{0:N}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
