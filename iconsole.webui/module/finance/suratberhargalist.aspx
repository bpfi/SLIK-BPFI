<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="suratberhargalist.aspx.cs" Inherits="module_debitur_suratberhargalist" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NO_REK_FASILITAS" HeaderText="No. Rek">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="TGL_PENERBITAN" HeaderText="Tanggal Penerbit" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                              <asp:BoundField DataField="TGL_PEMBELIAN" HeaderText="Tanggal Pembelian" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TGL_JATUH_TEMPO" HeaderText="Tanggal Jatuh Tempo" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="NILAI_PASAR" HeaderText="Nilai Pasar" DataFormatString="{0:N}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="NOMINAL" HeaderText="Nominal" DataFormatString="{0:N}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>
