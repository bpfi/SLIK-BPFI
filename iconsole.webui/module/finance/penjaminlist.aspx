<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="penjaminlist.aspx.cs" Inherits="module_debitur_penjaminlist" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NO_IDENTITAS_PENJAMIN" HeaderText="Identitas">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="NO_REKENING" HeaderText="No. Rek">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                             <asp:TemplateField>
                                <HeaderTemplate>
                                ...
                                <ItemStyle Width="35%"/>
                                <ItemTemplate>
                                    <asp:Label ID="lblAlamat" runat="server" Text='<%# Eval("ALAMAT_PENJAMIN")%>' Font-Bold="true"/><br />
                                </ItemTemplate>
                            </asp:TemplateField>
