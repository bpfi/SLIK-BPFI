<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="penguruslist.aspx.cs" Inherits="module_debitur_penguruslist" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NO_IDENTITAS_PENGURUSAN" HeaderText="Identitas">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="NAMA_PENGURUS" HeaderText="Nama Pengurus">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                             <asp:TemplateField>
                                <HeaderTemplate>
