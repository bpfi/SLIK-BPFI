...
public partial class module_debitur_pembiayaanjoinaccountlist : BasePageList
{
    private static string TABLE_NAME = "KREDIT_JOIN_ACCOUNT";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "F02";
    private Services cv = new Services();
    private F02Controller dc = new F02Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "KREDIT_JOIN_ACCOUNT";
        NEXT_PAGE = "pembiayaanjoinaccount.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityF02> list = new List<EntityF02>();
            list = cv.ConvertDataTable<EntityF02>(_dt);

            bool isCreate = dc.ValidateF02(list, header);

            if (isCreate)
                Shared.ShowSuccessGritter(this, string.Format("pembiayaanjoinaccountlist.aspx"));
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("pembiayaanjoinaccount.aspx?action=edit&code=" + gvwList.SelectedDataKey[0].ToString());
    }
}
