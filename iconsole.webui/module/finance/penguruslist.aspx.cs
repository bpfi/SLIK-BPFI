...
public partial class module_debitur_penguruslist : BasePageList
{
    private static string TABLE_NAME = "PENGURUS";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "M01";
    private Services cv = new Services();
    private M01Controller dc = new M01Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "PENGURUS";
        NEXT_PAGE = "penguruslist.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityM01> list = new List<EntityM01>();
            list = cv.ConvertDataTable<EntityM01>(_dt);

            bool isCreate = dc.ValidateM01(list,header);

            if (isCreate)
                Shared.ShowSuccessGritter(this, string.Format("penguruslist.aspx"));
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("pengurus.aspx?action=edit&cif=" + gvwList.SelectedDataKey[0].ToString()
            + "&no_identitas_pengurusan=" + gvwList.SelectedRow.Cells[2].Text
