<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="fasilitaskreditlist.aspx.cs" Inherits="module_debitur_fasilitaskreditlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span>Fasilitas Kredit List</span>
        </header>
                    ...
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TGL_JATUH_TEMPO" HeaderText="Tanggal Jatuh Tempo" DataFormatString="{0:dd/MM/yyyy}">
                             ...
                             <asp:BoundField DataField="NILAI_PROYEK" HeaderText="Nilai" DataFormatString="{0:N}">
