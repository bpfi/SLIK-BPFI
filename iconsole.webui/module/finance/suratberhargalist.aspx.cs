...
public partial class module_debitur_suratberhargalist : BasePageList
{
    private static string TABLE_NAME = "SURAT_BERHARGA";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "F03";
    private Services cv = new Services();
    private F03Controller dc = new F03Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "SURAT_BERHARGA";
        NEXT_PAGE = "suratberharga.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityF03> list = new List<EntityF03>();
            list = cv.ConvertDataTable<EntityF03>(_dt);

            bool isCreate = dc.ValidateF03(list, header);

            if (isCreate)
                Shared.ShowSuccessGritter(this, string.Format("suratberhargalist.aspx"));
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("suratberharga.aspx?action=edit&code=" + gvwList.SelectedDataKey[0].ToString());
    }
}
