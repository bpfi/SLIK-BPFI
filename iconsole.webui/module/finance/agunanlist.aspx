<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="agunanlist.aspx.cs" Inherits="module_debitur_agunanlist" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NO_REKENING_FASILITAS" HeaderText="No. Rekening">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="KD_REGISTRASI" HeaderText="Kode Registrasi">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                             <asp:TemplateField>
                                <HeaderTemplate>
                                ...
                                <ItemStyle Width="35%"/>
                                <ItemTemplate>
                                    <asp:Label ID="lblAlamat" runat="server" Text='<%# Eval("ALAMAT_AGUNAN")%>' Font-Bold="true"/><br />
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:BoundField DataField="NILAI_AGUNAN_LJK" HeaderText="Agunan LJK" DataFormatString="{0:N}">
                                <ItemStyle Width="20%" HorizontalAlign="right" />
                            </asp:BoundField> 
                            <asp:BoundField DataField="TGL_PENILAIAN_LJK" HeaderText="Tanggal Penilaian" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="right" />
                            </asp:BoundField> 
