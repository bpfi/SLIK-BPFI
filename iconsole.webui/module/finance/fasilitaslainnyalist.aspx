<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="fasilitaslainnyalist.aspx.cs" Inherits="module_debitur_fasilitaslainnyalist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span>Fasilitas Lainnya List</span>
        </header>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NO_REKENING_FASILITAS" HeaderText="No. Rek">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField>   
                             <asp:BoundField DataField="TGL_MULAI" HeaderText="Tanggal Mulai" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                            <asp:BoundField DataField="TGL_JATUH_TEMPO" HeaderText="Tanggal Jatuh Tempo" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
                            <asp:BoundField DataField="TGL_MACET" HeaderText="Tanggal Macet" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="left" />
                            </asp:BoundField> 
