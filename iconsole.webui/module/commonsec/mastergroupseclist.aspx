<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="mastergroupseclist.aspx.cs" Inherits="module_commonsec_mastergroupseclist" %>
                    ...
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chbChecked" HorizontalAlign="Center"/>
                                </ItemTemplate>
                            </asp:TemplateField>
