...
public partial class module_debitur_badanusahalist : BasePageList
{
    private static string TABLE_NAME = "DEBITUR_BADAN_USAHA";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "D02";
    private Services cv = new Services();
    private D02Controller dc = new D02Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "DEBITUR_BADAN_USAHA";
        NEXT_PAGE = "badanusaha.aspx";
    }
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("badanusaha.aspx?action=edit&cif=" + gvwList.SelectedDataKey[0].ToString()
            + "&nomor_identitas=" + gvwList.SelectedRow.Cells[3].Text
            + "&cre_date=" + gvwList.SelectedRow.Cells[6].Text
            + "&nama_badan_usaha=" + gvwList.SelectedRow.Cells[2].Text);
    }
}
