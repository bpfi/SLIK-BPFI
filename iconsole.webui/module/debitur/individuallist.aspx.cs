...
public partial class module_debitur_individuallist : BasePageList
{
    private static string TABLE_NAME = "DEBITUR_INDIVIDU";
    private static string TABLE_NAME_HEADER = "HEADER";
    private string SEGMENT = "D01";
    private Services cv = new Services();
    private D01Controller dc = new D01Controller();

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "DEBITUR_INDIVIDU";
        NEXT_PAGE = "debiturmain.aspx";
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            List<EntityD01> list = new List<EntityD01>();
            list = cv.ConvertDataTable<EntityD01>(_dt);
            
            bool isCreate = dc.ValidateD01(list, header);
                Shared.ShowSuccessGritter(this, "individuallist.aspx");
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("individual.aspx?action=edit&cif=" + gvwList.SelectedDataKey[0].ToString()
            + "&nik=" + gvwList.SelectedRow.Cells[3].Text
            + "&date=" + gvwList.SelectedRow.Cells[6].Text
            + "&nama=" + gvwList.SelectedRow.Cells[2].Text);
    }
}
