<%@ Page Title="" Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="individuallist.aspx.cs" Inherits="module_debitur_individuallist" %>
                    ...
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NAMA" HeaderText="Name">
                             ...
                             <asp:BoundField DataField="NO_TELEPON" HeaderText="No Telpon">
