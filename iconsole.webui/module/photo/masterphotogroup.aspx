<%@ Page Language="C#" MasterPageFile="~/iconsole.master" AutoEventWireup="true" CodeFile="masterphotogroup.aspx.cs" Inherits="module_question_masterphotogroup" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
            <span>Photo Group Detail List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8 ">
            ...
            <asp:UpdatePanel ID="updGroupRole" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="gvwListGroupRole" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        AllowPaging="true" PageSize="10" DataKeyNames="PHOTO_CODE" OnPageIndexChanging="gvwListGroupRole_PageIndexChanging" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PHOTO_CODE" HeaderText="Code">
