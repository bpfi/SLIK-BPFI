...
public partial class module_question_masterphotogroup : BasePage
{
    private static string TABLE_NAME = "MASTER_PHOTO_GROUP";
    private static string TABLE_NAME_DETAIL = "MASTER_PHOTO_GROUP_DETAIL";
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("masterphotogroup.aspx?action=edit&code={0}", txtCode.Text));
    ...
    {
        Response.Redirect(string.Format("masterphotogrouplist.aspx"));
    }
    ...
    {
        Response.Redirect(string.Format("masterphotogroupdetail.aspx?action=edit&photo_code={0}&group_code={1}", txtCode.Text, gvwListGroupRole.SelectedDataKey[1].ToString()));
    }
    ...
    {
        Response.Redirect("masterphotogroupdetail.aspx?action=add&code=" + txtCode.Text);
    }
