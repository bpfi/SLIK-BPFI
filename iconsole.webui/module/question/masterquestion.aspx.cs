...
public partial class module_question_masterquestionmain : BasePage
{
    private static string TABLE_NAME = "MASTER_QUESTION";
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("masterquestion.aspx?action=edit&code={0}", txtCode.Text));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect(string.Format("masterquestionlist.aspx"));
    }
