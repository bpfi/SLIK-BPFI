...
public partial class module_question_masterquestionlist : BasePageList
{
    ...
    {
        PAGE_LIST = "MASTER_QUESTION";
        NEXT_PAGE = "masterquestion.aspx";
    }
    ...
    {
        Response.Redirect("masterquestion.aspx?action=add");
    }
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("masterquestion.aspx?action=edit&code=" + gvwList.SelectedDataKey[0].ToString());
    }
