...
public partial class module_question_masterquestiongrouplist : BasePageList
{
    private static string TABLE_NAME = "MASTER_QUESTION_GROUP";

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "MASTER_QUESTION_GROUP";
        NEXT_PAGE = "masterquestiongroupmain.aspx";
    }
    ...
    {
        Response.Redirect("masterquestiongroupmain.aspx?action=add");
    }
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("masterquestiongroupmain.aspx?action=edit&code=" + gvwList.SelectedDataKey[0].ToString());
    }
